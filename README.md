...
### Phase 2: 功能完善 ✅
- [x] 数据持久化（书籍/进度/书签/笔记/高亮，drift + SQLite）
- [x] 书架管理
- [x] 阅读设置（字号/行距/字体/翻页动画/简繁转换/替换规则/分段规则）
- [x] 书签功能
- [x] 笔记与划线（长按选区、高亮渲染、备注、批量定位页码）
- [x] 书内全文搜索（A30）

### Phase 3: 格式扩展 (进行中)
- [x] EPUB 支持（结构化 IR + 富元素渲染）
- [ ] PDF 支持
- [ ] 在线书源

### Phase 4: 跨平台 (进行中)
- [x] Android 打包（arm64-v8a / armeabi-v7a / x86_64 分 ABI）
- [x] Windows 桌面
- [ ] iOS 适配
- [ ] Web 版本
