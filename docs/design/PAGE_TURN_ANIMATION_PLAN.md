...
| P1 | 接线层 | Store 接入 ReaderNotifier + 三页预加载 | ✅ 已完成 |
| P2 | 手势层 | 滑动检测 + 拖拽跟踪 | ✅ 已完成 |
| P3 | 动画层 | 翻页动画控制器（卷曲/滚动） | ✅ 已完成 |
| P4 | 渲染层 | 动画合成渲染 + 集成到 ReaderPage | ✅ 已完成 |
| P5 | 设置集成 | 翻页模式切换 + 持久化 | ✅ 已完成（UI 切换，持久化待后续） |
